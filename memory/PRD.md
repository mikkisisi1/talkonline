...
- [x] Страница Idols (20+ персонажей с фото и голосами)
- [x] PWA поддержка
...
- [x] **15.02.2026 - НОВЫЕ ГОЛОСА И ФОТО В IDOLS**
- [x] **15.02.2026 - SPLASH SCREEN с видео**
- [x] **15.02.2026 - DEPLOYMENT ГОТОВ** ✅:
  - Backend health endpoint: /api/health
  - Frontend использует VITE_BACKEND_URL
  - Убраны hardcoded URLs
  - Исправлен баг splash screen (добавлен fallback при ошибке загрузки видео)
  - Yarn build проходит успешно
...
- Deployment agent проверка: PASS
- Backend health: /api/health работает
- Frontend build: yarn build успешно
- Все API endpoints: работают
- Splash screen: исправлен fallback при ошибке видео
