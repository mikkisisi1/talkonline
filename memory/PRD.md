...
- [x] **Исправлен баг TTS** - 14.02.2026:
  - Агенты больше не озвучивают настройки
  - Fish Audio теги (soft tone) для естественности
- [x] **Естественный стиль общения** - 14.02.2026:
  - Как обычный человек в переписке с другом
  - Без наигранности, французских слов, сленга
  - Флирт только по контексту (если собеседник начинает)
  - Короткие ответы 1-4 предложения
  - Эмодзи редко, 1-2 максимум
